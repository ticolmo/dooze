...
class Reponsevisiteur extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'reponsevisiteur';
    ...
    {
        return $this->belongsTo(Commentairevisiteur::class, 'commentairevisiteur_id');
    }
