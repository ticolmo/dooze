      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu scrollable-menu">
            <li><a class="dropdown-item" href="{{route('createaccount.fan')}}" wire:navigate>fan</a></li>
            <li><a class="dropdown-item" href="{{route('createaccount.media')}}" wire:navigate>media</a></li>
          </ul>
        </li>
