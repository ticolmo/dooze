...
<div id="diagram">
    ...
    <div class="link">
        <span style="background-color:rgb(33, 37, 41)"></span>
    </div>
    <div class="etape">
        @if ($etape == "bio")
    ...
    <div class="link">
        <span @if ($etape == "bio") style="background-color:#80808093" @elseif($etape == "compte") style="background-color:rgb(33, 37, 41)" @endif ></span>
    </div>
    <div class="etape">
        @if ($etape == "bio")
        ...
        @endif  
            <div style="color:#808080" > Compte </div> 
    </div>
</div>
